...
{% hint style="info" %}
If you are running Deploy 4+, we recommend you generate Umbraco Deploy Artifact (UDA) files from the Deploy Dashboard instead of KUDU. For more information, see the [Deploy Dashboard]([../../deployment/deploy-operations/extract-schema-to-data-files.md](https://docs.umbraco.com/umbraco-cloud/deployments/deploy-dashboard)).
{% endhint %}
